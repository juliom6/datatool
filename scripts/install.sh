...
echo "export JAVA_HOME=$(dirname $(dirname $(update-alternatives --list javac)))" >> /home/datatool/.bashrc
...
echo "export SPARK_HOME=/opt/spark" >> /home/datatool/.bashrc
source /home/datatool/.bashrc
echo "export PATH=$PATH:$SPARK_HOME/bin" >> /home/datatool/.bashrc
source /home/datatool/.bashrc
